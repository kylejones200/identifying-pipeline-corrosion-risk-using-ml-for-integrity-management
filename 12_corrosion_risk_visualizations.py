...
def create_risk_visualizations(risk_df, work_list, metrics, plot: bool = False):
    ...
    if plot:
        ...
        ax1.set_title(
            "Corrosion Risk Score Distribution",
            fontsize=12,
            fontweight="bold",
            loc="left",
        )
        ...
        for coating in ["FBE", "PE", "CoalTar", "Tape"]:
            ...
            ax3.scatter(
                coating_data["cp_potential"],
                coating_data["risk_score"],
                c=coating_colors[coating],
                s=15,
                edgecolors="black",
                linewidths=0.5,
                alpha=0.5,
        ...
        ax3.set_title(
            "CP Potential vs Risk by Coating",
            fontsize=12,
            fontweight="bold",
            loc="left",
        )
        ...
        ax4.set_title(
            "Work List: Value per Dollar (Every 5th Joint)",
            fontsize=12,
            fontweight="bold",
            loc="left",
        )
